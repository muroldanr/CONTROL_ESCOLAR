...
class Menu extends Component {
	...
	render() {
		if(localStorage.getItem("role")  === "direccion"){
			content = [
				{
					"id": 'Directories',
					"label": "MENÚ"
					...
					<div style={this.state.parentlink === 'login' ? masterNone : masterBlock}>
						...
						<div id="rightsidebar" className={`right_sidebar ${isOpenRightSidebar && "open"}`}>
							...
							<div className="tab-content">
								...
								<div role="tabpanel" className="tab-pane vivify fadeIn" id="activity">
						...
						<div className={`user_div ${isOpenUserMenu && 'open'}`}>
							...
							<p className="user_btn mr-3" onClick={() => this.closeSesion()}>
